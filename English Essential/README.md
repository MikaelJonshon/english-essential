...
- redirecionamento por role (`student`, `teacher`, `admin`);
...
- tema `dark blue`, fullscreen, zoom, audio, microfone e notificacoes locais;
...
- suporta `multiple_choice`, `text`, `listening` e `speaking`;
